...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-40 overflow-hidden rounded-xl border border-border bg-popover/95 p-1 text-popover-foreground shadow-lift backdrop-blur-xl",
...
>(({ className, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      destructive &&
        "text-danger focus:bg-danger/10 focus:text-danger [&_svg]:text-danger",
      className,
    )}
    {...props}
  />
